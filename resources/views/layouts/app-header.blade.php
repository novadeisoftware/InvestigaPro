            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    {{--<div x-show="open" @click.away="open = false" x-transition
                        class="absolute right-0 z-50 mt-2 w-32 origin-top-right rounded-xl border border-gray-200 bg-white p-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900"
                        style="display: none;">
                        <div class="flex flex-col gap-1">
                            <a href="{{ url('lang/es') }}"
                                class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 {{ app()->getLocale() == 'es' ? 'bg-gray-50 dark:bg-gray-800/50' : '' }}">
                                <span>🇪🇸</span> Español
                            </a>
                            <a href="{{ url('lang/en') }}"
                                class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 {{ app()->getLocale() == 'en' ? 'bg-gray-50 dark:bg-gray-800/50' : '' }}">
                                <span>🇺🇸</span> English
                            </a>
                        </div>
                    </div>--}}
