<div class="p-8 space-y-8" x-data="{ loading: false }">
    <x-common.title pageTitle="Mis Investigaciones" />
    ...
    {{ $project->academic_status == 'approved' ? 'bg-green-100 text-green-600' : 'bg-brand-50 text-brand-600' }}">
                ...
                <div class="mb-5 h-16">
                    <h3
                        class="text-lg font-bold text-gray-900 dark:text-white line-clamp-2  transition-colors">
                        {{ $project->title }}
                    </h3>
        ...
        @empty
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">No tienes investigaciones aún</h3>
