    ...
    @if ($project->document_type == 'PROYECTO DE TESIS')
        ...
        <div class="max-w-full mx-auto flex flex-col lg:flex-row min-h-screen">
            ...
            <aside
                ...
                <div>
                    <div class="mb-12">
                        <p class="text-[10px] font-black text-brand-600 uppercase tracking-[0.3em] mb-2 italic">Setup
                            v1.0
                        </p>
                        <h1
                ...
                @elseif($step == 2)
                    ...
                    <div class="w-full max-w-full animate-fade-in">
                        <div class="flex items-center justify-between mb-12">
                            ...
                            <x-common.button-submit type="button" wire:click="generateTitles"
                                target="generateTitles" variant="brand" wire:loading.attr="disabled">
                        ...
                        <div class="space-y-4">
                            @if ($loading)
                                <div class="py-24 flex flex-col items-center">
                                    ...
                                    <p
                                        class="mt-4 text-[10px] font-black text-gray-400 uppercase tracking-widest italic">
                                        ...
                                        <div
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <x-form.input.text wire:model="formatSteps.{{ $index }}.titulo"
                                                    for="title" :error="$errors->has('formatSteps.{{ $index }}.titulo')" />
